...
create_clock -name tx_ref_clk   -period  16.00 [get_ports tx_ref_clk_p]
create_clock -name rx_ref_clk   -period  8.00 [get_ports rx_ref_clk_p]
create_clock -name rx_div_clk   -period  8.00 [get_pins i_system_wrapper/system_i/util_daq2_xcvr/inst/i_xch_0/i_gtxe2_channel/RXOUTCLK]
